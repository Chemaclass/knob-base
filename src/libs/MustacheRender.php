...
class MustacheRender
{
     ...
     * Singleton
     */
    protected static $mustacheRender = null;

    protected static $mustacheParams = null;
    ...
    {
        if (null == static::$mustacheRender) {
            $templatesFolder = static::getTemplatesFolderLocation();
            static::$mustacheRender = new Mustache_Engine(
                [
